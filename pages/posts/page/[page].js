...
import postsPageInitialPathsB56a7Resource from '../../../resources/posts-page-initial-paths-b56a7'
import postsPageInitialPropsCe760Resource from '../../../resources/posts-page-initial-props-ce760'
...
export async function getStaticPaths() {
  try {
    const response = await postsPageInitialPathsB56a7Resource({})
...
export async function getStaticProps(context) {
  try {
    const response = await postsPageInitialPropsCe760Resource({
      ...context?.params,
